        ...
        <div className="p-4 md:p-12">
            ...
            <div className="flex flex-col md:flex-row md:space-x-9">
                <p className="max-w-[40ch] leading-7 mt-8 text-sm">
                    Lambda Actions are programmable conditions that automate your authentication and signing workflows.
                    You can use
            ...
            <p className="leading-7 mt-8 text-md">
                <b>Question:</b>
                <br/>
                What was the hash of first bitcoin genesis block? If you get it right, the input will return a
                signature <a className="text-blue-600 underline"
                             href="https://btcscan.org/block/000000000019d6689c085ae165831e934ff763ae46a2a6c172b3f1b60a8ce26f">(Hint)</a>
            </p>
            ...
            <p className="leading-7 mt-8 text-md">
                <b>How it works:</b>
                <br/>
                In the input, enter a price target for ETH. If current ETH Price is greater than your price target,
                lambda returns a signature otherwise it doesn't.
            </p>
            <div className="flex flex-col-reverse md:flex-row p-12">
                <br/>
                <div className="flex flex-col items-center w-full md:w-1/2 mb-4 md:mb-0">
            ...
            <p className="leading-7 mt-8 text-md">
                <b>How it works:</b>
                <br/>
                You as developer owns the JWT Private Key. You register a verification lambda with us and you issue JWTs
                to your users allowing them to get signatures on your behalf.
                <br/>
                <a className="text-blue-600 underline" href="https://jwt.io/" target="_blank">Generate a JWT here</a>
                <br/>
            ...
            <div className="flex flex-col-reverse md:flex-row p-12">
                ...
                <div className="flex flex-col items-center w-full md:w-1/2 mb-12">
                    ...
                    {thirdLambdaOutput && (
                        <div className="mt-4 space-y-2 text-sm w-full overflow-x-auto">
                            <p className="break-words">Output: {thirdLambdaOutput.signature}</p>
